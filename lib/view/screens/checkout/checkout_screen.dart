...
class CheckoutScreenState extends State<CheckoutScreen> {
                      ...
                      child: SizedBox(
                        ...
                        child: ResponsiveHelper.isDesktop(context) ? Padding(
                          ...
                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                            Expanded(child: topSection(restController, charge, deliveryCharge, orderController, locationController, addressList, tomorrowClosed, todayClosed, price, discount, addOns, restaurantSubscriptionActive),
                            ),
                          ...
                          /// TopSection
                          topSection(restController, charge, deliveryCharge, orderController, locationController, addressList, tomorrowClosed, todayClosed, price, discount, addOns, restaurantSubscriptionActive),
  ...
  Widget topSection(RestaurantController restController, double charge, double deliveryCharge, OrderController orderController,
      ...
      double price, double discount, double addOns, bool restaurantSubscriptionActive) {
          ...
          child: CustomButton(
            ...
            if(!_isCashOnDeliveryActive! && !_isDigitalPaymentActive! && !_isWalletActive) {
              ...
              orderController.placeOrder(PlaceOrderBody(
                ...
                dmTips: (orderController.orderType == 'take_away' || orderController.subscriptionOrder) ? '' : _tipController.text.trim(),
